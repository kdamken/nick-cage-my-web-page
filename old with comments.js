$(document).ready(function(){
    ...
    */
    ...
    // handles the extension to provide the different varieties of image type urls
    ...
    function initNick() {
        ...
        //Functions for checking if something is a tall or wide rectangle, which will a repeating background images when that would look best
        ...
        $('img').each(function(){
            ...
            if ( (w >= 1) && (h >= 1) ) {
                ...
                if (wide || tall) {
                    ...
                    newUrl = 'background-image: url("' + settings.placeholderSite + imgType + w + '/' + h + '");';
